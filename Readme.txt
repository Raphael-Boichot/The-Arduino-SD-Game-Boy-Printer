...
1) Choose an image and modify it so that it is only 4 shades of gray, 160 pixels wide, eigth multiple of 16 pixels. You can choose a pixel perfect image from your Game Boy Camera or other games using the Game Boy Printer also.

...
byte ZERO[]={0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}; //command allegedly sent by GB camera to flush the printer buffer...
...
//// we have to flush now the memory for printing remaining packets
  ...
  sequence(PRNT, 13, mode,13);// here we send the last printing command
    ...
    Serial.println(' ');
    Serial.println("16 ZERO BYTES");
    sequence(ZERO, 15, mode,15);

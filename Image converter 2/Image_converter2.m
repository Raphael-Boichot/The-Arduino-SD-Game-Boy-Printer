...
%by default each data packet occupies 2048 bytes, so the SD card must have
%clusters of at least this size
...
Lgray=C(3);
White=C(4);
STR='These data are added in order to avoid any data packet to be in-between two clusters. They are simply discarded by the Arduino';   
hor_tile=largeur/8;
vert_tile=hauteur/8;
tile=0;
H=1;

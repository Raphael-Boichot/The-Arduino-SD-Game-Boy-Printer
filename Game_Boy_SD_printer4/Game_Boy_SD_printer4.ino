/*
  ...
  I adopt a textfile format in command to be consistent with data file on SD card, even if is is not usefull, it ease the reading
*/
#include <SD.h>
...
void setup() {
  ...
  //int mode=3; //minimal serial output
...
int indentification(char variable){ // this function converts characters into hexadecimal values
int transmission;
...
void printing(int semibyte1, int semibyte2, int mode){// this function prints bytes

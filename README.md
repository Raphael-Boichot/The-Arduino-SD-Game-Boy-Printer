...
The printer also has an early variant motherboard with a NEC MCU having only 8 kbytes of rom data (the rom data are probably the same than the ones of the 32 kbytes Toshiba) and 8 kbytes of ram extension but this microcontroller is very poorly documented.

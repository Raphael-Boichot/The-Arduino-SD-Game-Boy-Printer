...
# Summary
 ...
 1. OR simply pick a digital Game Boy image printed from Camera or any game (must be pixel perfect, 4 shades of gray) ;
 2. Convert it in Game Boy tile format with Octave/Matlab tool ;

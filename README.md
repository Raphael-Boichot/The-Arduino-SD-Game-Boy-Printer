...
Funfact, this project is compatible with the [NeoGB Printer](https://github.com/zenaro147/NeoGB-Printer), which means that you can fake a print on a fake printer, which is the most convoluted way of transmitting a 2bbp image.
